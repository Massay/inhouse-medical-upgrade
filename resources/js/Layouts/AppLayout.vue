                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink v-if="can.view_visits" :href="route('visits.index')"
                                    :active="$page.url.startsWith('/visits')">
                                    Visits
                                </NavLink>
                                <NavLink v-if="can.view_partners" :href="route('partners.index')"
                                    :active="$page.url.startsWith('/partners')">
                                    Partners
                                </NavLink>
                                <NavLink v-if="can.view_users" :href="route('users.index')"
                                    :active="$page.url.startsWith('/users')">
                                    Users
                                </NavLink>
                                <NavLink v-if="can.view_employees" :href="route('employees.index')"
                                    :active="$page.url.startsWith('/employees')">
                                    Employee
                                </NavLink>
                                <NavLink v-if="can.view_reports" :href="route('reports.index')"
                                    :active="$page.url.startsWith('/reports')">
                                    Reports
                                </NavLink>
                                <NavLink v-if="can.view_settings" :href="route('settings.index')"
