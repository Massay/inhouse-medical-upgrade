    ...
    <div
        ...
        <div v-if="canLogin" class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
            ...
            <template v-else>
                <Link :href="route('login')"
                    class="font-extrabold border px-8 py-2 rounded-full bg-gray-50  text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                Log in</Link>
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                <ApplicationMark class="h-28 rounded-lg" />
            ...
            <div class="flex justify-center mt-16 px-6 sm:items-center sm:justify-between">
                ...
                <div class="ml-4 text-center text-sm text-gray-500 dark:text-gray-400 sm:text-right sm:ml-0">
                    InHouse Medical v{{ laravelVersion }}
                </div>
            </div>
        </div>
    </div>
