...
<template>
    <AppLayout title="Visits">
        <template #header>
            ...
            <div class="flex justify-between">
                ...
                <Link class="flex items-center border space-x-2  border-gray-800 p-1 text-gray-800 font-semibold rounded-md px-6 py-2" as="button" :href="route('visits.create')">
                        <span class=" rounded-full border border-gray-900">
  ...
  <path fill-rule="evenodd" d="M12 3.75a.75.75 0 01.75.75v6.75h6.75a.75.75 0 010 1.5h-6.75v6.75a.75.75 0 01-1.5 0v-6.75H4.5a.75.75 0 010-1.5h6.75V4.5a.75.75 0 01.75-.75z" clip-rule="evenodd" />
                ...
                <span>Add Visit Entry</span></Link>
            </div>
