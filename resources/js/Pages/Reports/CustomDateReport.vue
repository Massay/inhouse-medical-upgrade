...
function submit() {
    form.get(route('reports.custom_date'), {
        preserveScroll: true,
        preserveState: true
    })
}
...
<template>
    <AppLayout title="Custom Date Report">
        <template #header>
        ...
        <div class="py-12">
            <div class="max-w-[90%] mx-auto sm:px-6 lg:px-8">
                ...
                <form @submit.prevent="submit">
                    <div class="sm:rounded-lg grid grid-cols-2 gap-4 p-2">
                        <Datepicker v-model="form.start_date" class="w-full rounded-md" placeholder="Start Date" />
                        <Datepicker v-model="form.end_date" class="w-full rounded-md" placeholder="End Date" />
                        ...
                        <select name="" id="" class="w-full rounded-md" v-model="form.employee_id">
                                <option :value="null" disabled>Employee</option>
                    ...
                    <div class="flex justify-end p-2">
                        <button @click.prevent="reset" type="button" class="border px-8 py-2 border-gray-500 text-gray-50 bg-red-400 rounded-md">Clear</button>
                        <button class="border px-8 py-2 bg-gray-500 text-gray-50 rounded-md">Submit</button>
                    </div>
                </form>

                <div v-if="visits && visits.data != null">
                    <table class="w-full">
