        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div>
                    ...
                    <h1 class="text-lg"> <span>Max Amount: <span v-if="type.perPerson">Per Person </span> <span v-else>Per
                                Family </span> </span>
                    ...
                    <h1> <span class="uppercase">policy: </span><span class="font-extrabold"> {{ type.policy.name }}</span>
                    </h1>
                </div>
